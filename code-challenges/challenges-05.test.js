...
const listFoods = (recipe) => {
  ...
  recipe.ingredients.forEach(value => {
    result.push(value.slice((value.indexOf(' ', 5))+1));
  });
  return result;
};
...
Write a function named splitFoods that uses split to produce the same output as Challenge 3. // Guessing this means challenge 4
